...
<div className="well">    
    <div className="card item-card booking-card m-4">
        <div className="view overlay d-flex flex-column">
            <img className="item-card-img p-4" src="/assets/img/images-shirt-placeholder.png" alt="Card image cap"/>
            <a href="#!">
        ...
        <div className="card-body d-flex flex-column align-items-center">
            <h5 className="card-title font-weight-bold"><a>Harajuku's T-shirts</a></h5>
            <span> &#163; 14.99 </span>
        ...
        <div className="item-card-top ict-quickview">
            <h5 className="card-title font-weight-bold bg-transparent"><a className="text-dark bg-transparent" href="#">Harajuku's T-shirts</a></h5>
            <h4 className="text-danger"> &#163; 14.99 </h4>
